...
dir.create("~/discordBot/outputs/weather/winds", showWarnings = FALSE)
setwd("~/discordBot/outputs/weather/winds")
...
# Create gif
output_gif <- "~/discordBot/outputs/weather/wind_animation.gif"
